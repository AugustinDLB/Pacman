...
DISTDIR = /home/lab/oopc/28/Desktop/Pacman\ bis/.tmp/Pacman1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
distdir: FORCE
	...
	$(COPY_FILE) --parents main.cpp PacmanWindow.cpp $(DISTDIR)/
...
main.o: main.cpp PacmanWindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

PacmanWindow.o: PacmanWindow.cpp PacmanWindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o PacmanWindow.o PacmanWindow.cpp
